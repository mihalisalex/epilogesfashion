...
const BANK_TRANSFER_METHOD: PaymentMethodDefinition = {
  ...
  defaultDisplayName: "Άμεση τραπεζική μεταφορά",
  defaultDescription: "Πληρωμή με κατάθεση ή e-banking στο IBAN μας. Θα λάβετε τα στοιχεία του λογαριασμού και τον αριθμό παραγγελίας ως αιτιολογία — η αποστολή γίνεται μόλις εμφανιστεί η πληρωμή.",
